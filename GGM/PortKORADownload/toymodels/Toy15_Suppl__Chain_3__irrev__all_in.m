function ydot=Toy15_Suppl__Chain_3__irrev__all_in(t,y,params)
...
ydot(2)=+1*(params(2)*y(1))-1*(params(3)*y(2))+1*(params(4));
ydot(3)=+1*(params(3)*y(2))+1*(params(5))-1*(params(6)*y(3));
