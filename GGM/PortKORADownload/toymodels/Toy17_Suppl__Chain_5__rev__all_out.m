function ydot=Toy17_Suppl__Chain_5__rev__all_out(t,y,params)
...
ydot(2)=+1*(params(2)*y(1))-1*(params(3)*y(2))-1*(params(4)*y(2))+1*(params(5)*y(3))-1*(params(10)*y(2));
ydot(3)=+1*(params(4)*y(2))-1*(params(5)*y(3))-1*(params(6)*y(3))+1*(params(7)*y(4))-1*(params(11)*y(3));
ydot(4)=+1*(params(6)*y(3))-1*(params(7)*y(4))-1*(params(8)*y(4))+1*(params(9)*y(5))-1*(params(12)*y(4));
ydot(5)=+1*(params(8)*y(4))-1*(params(9)*y(5))-1*(params(13)*y(5));
