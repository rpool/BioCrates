function ydot=Toy31_Suppl__Big_split__irrev__all_in_out(t,y,params)
...
% equations
ydot=zeros(6,1);
ydot(1)=+1*(params(1))-1*(params(7)*y(1))-1*(params(10)*y(1));
ydot(2)=+1*(params(2))+1*(params(7)*y(1))-1*(params(8)*y(2))-1*(params(11)*y(2))-1*(params(14)*y(2));
ydot(3)=+1*(params(3))+1*(params(8)*y(2))-1*(params(9)*y(3))-1*(params(12)*y(3));
ydot(4)=+1*(params(4))+1*(params(9)*y(3))-1*(params(13)*y(4));
ydot(5)=+1*(params(5))+1*(params(14)*y(2))-1*(params(15)*y(5))-1*(params(16)*y(5));
ydot(6)=+1*(params(6))+1*(params(15)*y(5))-1*(params(17)*y(6));
