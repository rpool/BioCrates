function ydot=Toy12_Suppl__Chain_3__rev__all_in(t,y,params)
...
ydot(2)=+1*(params(2)*y(1))-1*(params(3)*y(2))-1*(params(4)*y(2))+1*(params(5)*y(3))+1*(params(6));
ydot(3)=+1*(params(4)*y(2))-1*(params(5)*y(3))+1*(params(7))-1*(params(8)*y(3));
