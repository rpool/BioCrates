function ydot=Toy38_Suppl__Dense__all_irrev(t,y,params)
...
ydot(2)=+1*(params(3))-1*(params(4)*y(2))-1*(params(7)*y(2));
ydot(3)=+1*(params(5)*y(1))+1*(params(8))-1*(params(9)*y(3))-1*(params(10)*y(3));
ydot(4)=+1*(params(6)*y(1))+1*(params(7)*y(2))-1*(params(11)*y(4));
ydot(5)=+1*(params(10)*y(3))-1*(params(12)*y(5))-1*(params(13)*y(5));
ydot(6)=+1*(params(11)*y(4))+1*(params(13)*y(5))-1*(params(14)*y(6));
